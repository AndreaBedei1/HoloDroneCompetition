...
\end{tikzpicture}
\caption{Team-level evaluation of a staggered two-rover fleet: the team elapsed time spans the earliest release to the latest finish (\eqref{eq:team_time}) and the team summary aggregates gates and penalties (\eqref{eq:team_gates} to \eqref{eq:team_pen}). The rovers form one cooperative team, not competitors.}
