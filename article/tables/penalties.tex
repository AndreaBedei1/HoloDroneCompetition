\begin{table}[t]
\centering
\caption{Referee events, default penalties and which terminate the run. All values are configurable in the \texttt{referee} block (v0.1 defaults shown).}
\label{tab:penalties}
\footnotesize
...
Inter-vehicle (penalize mode) & $5.0$\,s per pair & no (team-level) \\
\bottomrule
\end{tabular}
\par\vspace{0.6mm}
