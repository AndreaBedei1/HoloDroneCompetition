...
\end{equation}
where $P_i$ is the per-rover penalty total of \eqref{eq:penalized} and $P_{\mathrm{ivc}}$ counts each inter-vehicle event once per pair, not once per rover. Fig.~\ref{fig:fleet_scoring} illustrates the aggregation.
