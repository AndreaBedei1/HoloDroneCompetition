...
def run_status(run_dir: str | Path) -> Dict[str, Any]:
    ...
    result = {
        ...
        "three_gate_status": status.get("three_gate_status", "not_evaluated"),
        "three_gate_evaluated": bool(status.get("three_gate_evaluated", False)),
        "three_gate_n": int(status.get("three_gate_n", 0) or 0),
        "three_gate_note": status.get("three_gate_note"),
