\begin{table}[t]
\centering
\caption{Onboard perception audit along the reference controller's own
trajectory on the three official circuits, native HoloOcean simulator backend, 60 frames per
circuit. Ground truth was used only offline to score the front end and never
