...
circuit along the trajectories of a single reference controller under
current-free conditions on the three official circuits. The sample is therefore
small and covers one controller and one disturbance setting; the proportions
below describe the recorded frames and are reported descriptively. Ground truth
was used only offline to evaluate the perception output and never entered the
control loop. Table~\ref{tab:perception_audit} summarizes detection
