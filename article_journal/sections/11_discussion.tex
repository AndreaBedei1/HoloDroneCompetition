...
documented respect on the same circuits under the same protocol. On the short
planar circuit their records are identical on every discrete metric; on the long
mixed course, suspending late visual corrections completed all five seeds where
continuous correction completed two; on the vertical circuit a single seed
separates them. These are outcomes recorded over a small number of seeds, not
orderings the benchmark establishes.
