...
validation sample is small, the policy was developed with access to the official
circuits, and the learning protocol is not factorially matched to the 78-run
rule-controller matrix. Broader comparisons of recurrent architectures,
